...
namespace ShaderCrew.SeeThroughShader
{
    public class SeeThroughShaderQuickSetup : EditorWindow
    {
        ...
        void DrawDropFields2()
        {
            ...
            layerMasks = EditorGUILayout.MaskField("Layer Mask",
                          InternalEditorUtility.LayerMaskToConcatenatedLayersMask(layerMasks),
                          UnityEditorInternal.InternalEditorUtility.layers, GUILayout.MaxWidth(300));

            // Convert the LayerMask back to its original form
            layerMasks = InternalEditorUtility.ConcatenatedLayersMaskToLayerMask(layerMasks);
