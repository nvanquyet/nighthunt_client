...
#if USING_HDRP
                    // Unity 6 fix: Only disable CrossSection for actual HDRP materials.
                    // When both HDRP and URP are installed, USING_HDRP is always defined
                    // but URP materials should still have CrossSection enabled.
                    if (rp == RenderPipeline.HDRP && material.HasProperty("_CrossSectionEnabled") )
                    {
                        GUI.enabled = false;
