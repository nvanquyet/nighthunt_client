...
{
    [CustomEditor(typeof(GlobalShaderPropertySync))]
    public class GlobalShaderPropertySyncEditor : Editor
    {
        private GlobalShaderPropertySync globalShaderPropertySync;
        ...
        {
            globalShaderPropertySync = (GlobalShaderPropertySync)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            showDescription = EditorUtils.LogoOnlyStartWithDescription(Strings.GLOBAL_SHADER_PROPERTY_SYNC_TITLE,
                                                                    Strings.GLOBAL_SHADER_PROPERTY_SYNC_DESCRIPTION,
                                                                    showDescription);
