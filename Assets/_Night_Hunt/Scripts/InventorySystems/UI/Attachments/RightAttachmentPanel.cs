...
{
    /// <summary>
    /// Right attachment panel - shows attachments for hovered equipped item.
    /// Spawns AttachmentSlotUI dynamically.
    /// </summary>
    public class RightAttachmentPanel : MonoBehaviour
    {
        [Header("References")]
        [SerializeField] private Transform slotContainer;
        [SerializeField] private AttachmentSlotUI attachmentSlotPrefab;
        ...
        /// <summary>
        /// Show attachments for equipped item.
        /// </summary>
        ...
        private void SpawnAttachmentSlot(AttachmentSlotType slotType)
        {
            ...
            var slotUI = Instantiate(attachmentSlotPrefab, slotContainer);
        ...
        {
            if (enableDebugLogs)
                Debug.Log($"[RightAttachmentPanel] {message}");
        }
    }
}
