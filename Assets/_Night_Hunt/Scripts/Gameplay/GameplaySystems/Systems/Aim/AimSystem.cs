        ...
        private void UpdateCursorVisibility()
        {
            ...
            if (_worldAimCursor != null && _worldAimCursor.gameObject.activeSelf != shouldBeVisible)
            {
                ...
                PhaseTestLog.Log(
                    ...
                    "AimCursorVisibility",
                    $"visible={shouldBeVisible} cursor={_worldAimCursor.name} throwableMode={_isThrowableMode} isAnyAimingActive={ThrowableAimController.IsAnyAimingActive}",
                    this);
            }
        }
