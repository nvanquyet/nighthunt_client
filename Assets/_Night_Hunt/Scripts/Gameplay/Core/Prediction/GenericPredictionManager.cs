...
namespace NightHunt.Gameplay.Core.Prediction
{
    ...
    /// This is a generic type-safe prediction manager for state-based prediction.
    /// For object-based prediction, see NightHunt.Networking.Prediction.Core.PredictionManager.
    /// </summary>
    /// <typeparam name="TState">Type of state to predict</typeparam>
    public class GenericPredictionManager<TState> where TState : struct
    {
        ...
        public GenericPredictionManager(IPredictable<TState> predictable, int bufferSize = 60)
        {
